    ...
    try {
        ...
        const sql = `
            ...
            JOIN users u ON c.user_id = u.id
             LEFT JOIN rcs_configs rc ON COALESCE(mt.rcs_config_id, u.rcs_config_id) = rc.id
            LEFT JOIN whatsapp_configs wc ON COALESCE(mt.whatsapp_config_id, u.whatsapp_config_id) = wc.id
