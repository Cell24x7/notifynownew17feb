                        ...
                        <Card className="border-none shadow-sm h-full overflow-visible bg-card">
                            ...
                            <CardContent className="p-0 overflow-visible">
                                <Table className="border border-border">
                                        <TableHeader className="bg-white" style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white' }}>
                                            <TableRow className="bg-white hover:bg-white h-12">
                                                <TableHead style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white' }} className="w-[60px] font-semibold text-foreground border-r border-b border-border px-3 text-[10px] uppercase tracking-wider">Id</TableHead>
                                                <TableHead style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white' }} className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider py-3 text-center border-r border-b border-border">Rtime</TableHead>
                                                <TableHead style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white' }} className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider py-3 text-center border-r border-b border-border">Mobile</TableHead>
                                                <TableHead style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white' }} className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider py-3 text-center border-r border-b border-border">Channel</TableHead>
                                                <TableHead style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white' }} className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider py-3 text-center border-r border-b border-border">SendTime</TableHead>
                                                <TableHead style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white' }} className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider py-3 text-center border-r border-b border-border">DelTime</TableHead>
                                                <TableHead style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white' }} className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider py-3 text-center border-r border-b border-border">ReadTime</TableHead>
                                                <TableHead style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white' }} className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider py-3 text-center border-r border-b border-border">Template</TableHead>
                                                <TableHead style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white' }} className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider py-3 text-center border-r border-b border-border">Message</TableHead>
                                                <TableHead style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white' }} className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider py-3 text-center border-r border-b border-border">Campaign</TableHead>
                                                <TableHead style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white' }} className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider py-3 text-center border-r border-b border-border">Status</TableHead>
                                                <TableHead style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white' }} className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider py-3 text-center border-b border-border">Reason</TableHead>
                                            </TableRow>
                                        </TableHeader>
                                    <TableBody>
                                        {loadingLogs ? (
