...
export function AppSidebar({ onClose }: AppSidebarProps) {
  ...
  const navItems = [
    ...
    { icon: Smartphone, label: 'Channels', path: '/channels', show: Boolean(Number(user?.is_proero_enabled)) || user?.role === 'superadmin' || user?.role === 'admin' || user?.impersonatedBy === 'superadmin' },
