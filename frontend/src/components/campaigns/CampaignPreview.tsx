...
import { Shield, ChevronLeft, MoreVertical, Plus, Smile, Image as ImageIcon, Send, Link, Phone } from 'lucide-react';
...
export function CampaignPreview({ campaignData, template, variables }: CampaignPreviewProps) {
  ...
  if (!template) {
    return (
      <div className="h-full flex items-center justify-center text-muted-foreground p-8 text-center bg-[#f0f2f5] rounded-3xl border-2 border-dashed mx-auto w-[280px]">
  ...
  return (
    <div className="mx-auto w-[300px] h-[600px] bg-[#1a1a1a] rounded-[3rem] p-3 shadow-2xl relative border-[4px] border-[#333]">
      {/* Phone Features */}
      ...
      <div className="h-full w-full bg-[#f0f2f5] dark:bg-[#0b141a] rounded-[2.5rem] overflow-hidden flex flex-col relative z-10">
        ...
        <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-4">
            ...
            {/* MESSAGE BUBBLE - Simplified and Robust */}
            <div className="w-full max-w-[90%] bg-white dark:bg-[#1f2c33] rounded-2xl rounded-tl-sm shadow-md border border-black/5 overflow-hidden flex flex-col">
                {/* Header Media */}
...
// Add simplified FileText for local usage since it wasn't imported
